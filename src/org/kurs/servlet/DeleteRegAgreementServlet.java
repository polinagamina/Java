...
@WebServlet(urlPatterns = { "/deleteRegAgreement" })
public class DeleteRegAgreementServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	 
    public DeleteRegAgreementServlet() {
        super();
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            DBUtils.deleteRegAgreement(conn, id);
        ...
        if (errorString != null) {
            ...
            RequestDispatcher dispatcher = request.getServletContext()
                    .getRequestDispatcher("/WEB-INF/views/deleteRegAgreementErrorView.jsp");
