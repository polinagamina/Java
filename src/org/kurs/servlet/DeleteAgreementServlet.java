...
@WebServlet(urlPatterns = { "/deleteAgreement" })
public class DeleteAgreementServlet  extends HttpServlet{
	private static final long serialVersionUID = 1L;
	 
    public DeleteAgreementServlet() {
        super();
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            DBUtils.deleteAgreement(conn, id);
        ...
        if (errorString != null) {
            ...
            RequestDispatcher dispatcher = request.getServletContext()
                    .getRequestDispatcher("/WEB-INF/views/deleteAgreementErrorView.jsp");
